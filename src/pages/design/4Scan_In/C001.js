...
export default class C001 extends Component {
    constructor(props) {
        super(props);
    ...
    */
    ...
    initDatabase = () => {
        ...
        console.log('database sudah jalan di C001!')
    }
    ...
    */
        ...
        try {
            ...
            if (result.length == 3) {
                ...
                if (stat >= 400 && stat <= 500) {
                    ...
                    logger.error(`@Gleenald HTTP Stat: 400,{function: ScanQR(), page:C001}, ClientSide Error NodeMsg: ${data.description}, USERNAME: ${this.realmDb.objects("Login")[0]["username"]}`)
                    this.setState({
                        isWaiting: false,
                ...
                if (stat >= 500 && stat <= 600) {
                    console.log(data.description);
                    logger.error(`@Gleenald HTTP Stat: 500,{function: scanQR(), page:C001}, ServerSide Error NodeMsg: ${data.description}, USERNAME: ${this.realmDb.objects("Login")[0]["username"]}`)
                    this.setState({
            ...
            console.log(err);
            logger.error(`@Gleenald Application catch error, {function: scanQR(), page: C001}, logMsg: ${err}, USERNAME: ${this.realmDb.objects("Login")[0]["username"]}`)
            this.setState({
                isWaiting: false,
                isError: true
            })
    ...
    submit = async () => {
        try {
            ...
            if (stat >= 400 && stat <= 500) {
                console.log(data.description);
                logger.error(`@Gleenald HTTP Stat: 400,{function: manualInput(), page:C001}, ClientSide Error NodeMsg: ${data.description}, USERNAME: ${this.realmDb.objects("Login")[0]["username"]}`);
                this.setState({
                    isClientSideError: true,
                    isWaiting: false,
                    isManualInput: false
            ...
            if (stat >= 500 && stat <= 600) {
                console.log(data.description);
                logger.error(`@Gleenald HTTP Stat: 500,{function: manualInput(), page:C001}, ServerSide Error NodeMsg: ${data.description}, USERNAME: ${this.realmDb.objects("Login")[0]["username"]}`);
                this.setState({
                    isServerSideError: true,
                    isWaiting: false,
                    isManualInput: false
            ...
            console.log(err);
            logger.error(`@Gleenald Application catch error, {function: manualInput(), page: C001}, logMsg: ${err}, USERNAME: ${this.realmDb.objects("Login")[0]["username"]}`)
            this.setState({ isWaiting: false })
                        ...
                        onPress={
                            () => {
                                try {
                                    ...
                                    console.log(err);
                                    logger.error(`@Gleenald Application catch error, {function: getBack(), page:C01}, logMsg: ${err}, USERNAME: ${this.realmDb.objects("Login")[0]["username"]}`)
                                    this.setState({ isError: true })
                                }
                            }
                        }
